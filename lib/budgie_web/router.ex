defmodule BudgieWeb.Router do
  use BudgieWeb, :router

  import BudgieWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {BudgieWeb.Layouts, :root}
  ...
  # scope "/api", BudgieWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:budgie, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: BudgieWeb.Telemetry
  ...
  scope "/", BudgieWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{BudgieWeb.UserAuth, :redirect_if_user_is_authenticated}] do
